    ...
    return (
      <div>
        <CheckboxItem className = {styles['am-list-item']} className = {styles['am-list-thumb']} style = {{borderTop:'10px solid #eee'}}>
          <Flex>
            <img src = {userImg} style = {{width:'40px',height:'40px',borderRadius:'20px',marginRight:'10px'}} />
            <span>这是店铺的名字</span>
          </Flex>
        </CheckboxItem>
          ...
          <Flex>
            ...
            <Flex className = {styles['good-item']} style = {{width:'100%'}}>
              ...
              <Flex.Item classnam = {styles['decribe-frame']} style = {{width:'100%',fontSize:'14px',overflow:'hidden',whiteSpace:'nowrap',textOverflow:'ellipsis'}}>
                <span style = {{width:'100%',overflow:'hidden',whiteSpace:'nowrap',textOverflow:'ellipsis',fontWeight:'600',fontSize:'16px'}}>我是商品的简介哈哈哈哈占位符字数多少都没有关系</span><br/>
                <div style = {{border:'1px solid #ccc',fontSize:'14px',lineHeight:'2em',paddingLeft:'8px',borderRadius:'3px'}} onClick={this.showModal('modal2')}>白色，3L<img src={require('../svg/arrowdown.svg')} style = {{float:'right',width:'15px',height:'15px',margin:'6px 3px 0 0'}}/></div>
                <WhiteSpace />
                <Modal
                 popup
                ...
                >
                 <div>
                   <Flex style = {{margin:'10px'}}>
                     <img src = {goodImg} className = {styles['modal-good-img']}/>

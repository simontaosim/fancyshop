...
class Address extends React.Component {
  ...
  render(){
    return(
    <div>
      <div style = {{marginTop:'15px',border:'1px dashed #aaa',borderRadius:'5px',backgroundColor:'#fff',width:'90%',margin:'50px auto 0 auto',fontSize:'16px',padding:'10px'}}>
        <Flex>
      ...
      <div style = {{marginTop:'60px',border:'1px dashed #aaa',borderRadius:'5px',backgroundColor:'#fff',width:'90%',margin:'10px auto',fontSize:'16px',padding:'10px'}}>
        <Flex>
          <img src={require('../svg/people.svg')} className = {styles['item-icon']}/>店铺名：这是一个好听的名字
        </Flex>
        <WhiteSpace/>
